package com.bash.mysharedpreferences
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    companion object{
        ...
        private const val FIELD_IS_NOT_VALID = "email ini tidak valid"
    }
    ...
    override fun onClick(v: View) {
        if(v.id == R.id.btn_save){
            ...
            val isLoveMC = rg_love_mu.checkedRadioButtonId == R.id.rb_yes
            ...
            saveUser(name, email, age, phoneNo, isLoveMC)
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, loveMC: Boolean) {
